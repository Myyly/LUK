...
require_once '../../Controllers/Emotions.php';
$emotionController = new EmotionsController();
...
<script>
    // Function to hide the emoji picker when clicking outside of it
...
function handleFileUpload(event) {
    ...
    // Update selectedImages with new files
    selectedImages = selectedImages.concat(files);

    // Clear current previews to update the selected image list
...
//     const imageFiles = getImageFiles();  // Lấy các tệp hình ảnh
//     const formData = new FormData(this);

//     // Duyệt qua các tệp hình ảnh và thêm vào FormData
//     imageFiles.forEach(file => {
//         formData.append("images[]", file);  // Gửi ảnh dưới dạng tệp
//     });

//     // Gửi formData với các ảnh đính kèm qua AJAX
//     event.preventDefault();
//     fetch('../../Process/profile_process.php', {
//         method: 'POST',
//         body: formData
//     })
