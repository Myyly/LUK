...
$avatarSrc = $user->getProfile_picture_url();
$posts = $accountController->getAllPostsOfUser(6);
...
?>
    <div class="post-container">
        <div class="post-header">
            ...
            ?>
            <img src="<?php echo $avatarSrc; ?>" class="avatar-post" alt="User Avatar" style="margin-left: 10px;">
            <div class="post-user-info">
                ...
                <?php } ?>
                <time><?php echo $post->getCreate_at(); ?></time>
        ...
        <div class="post-stats">
            ...
            <span style="margin-left: 490px;">
                ...
                <?php include 'detailCommentOfPost.php'; ?>
            </span>
...
<script>
    ...
    function openImageOverlay(imageId, postId) {
        ...
        window.location.href = url; // This navigates to the URL in the current window
        // or
