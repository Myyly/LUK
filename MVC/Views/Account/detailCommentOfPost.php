<style>
    .modal-body-comment {
        ...
        /* Giới hạn chiều cao của modal body, tránh làm tràn ra khỏi cửa sổ */
        overflow-y: auto;
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                ?>
                <h5 class="modal-title" id="modalLabel" style="color: #000;"><strong>Bài viết của <?php echo $name; ?></strong></h5>
                <form action="../../Process/profile_process.php" method="POST">
                    <button type="submit" class="btn-close" name="btnCloseModal"></button>
                </form>
            </div>
            <div class="modal-body-comment">
                <div class="post-content-modal">
                    <div class="post-header-modal">
                        <img src="<?php echo $avatarSrc; ?>" alt="Profile Image" class="rounded-circle" style="width: 50px; height: 50px;">
                        <div class="post-info-modal">
                            <strong><?php echo $name ?></strong>
                            <p><?php echo $post->getCreate_at(); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="post-images d-flex">
                        <?php
                        $images = $accountController->getAllImagesOfPost($post->getPost_id());
            ...
            <div class="modal-footer">
                <div class="comment-section-modal">
                    <img src="<?php echo $avatarSrc; ?>" alt="User Profile" class="profile-pic" style="width: 40px; height: 40px;  border-radius: 50%;">
                    <textarea class="comment-input" id="commentInput_<?php echo $post->getPost_id(); ?>" placeholder="Viết bình luận..." name="content_comment"></textarea>
                    <div class="icons">
                        <i class="icon fa-regular fa-smile"></i>
                        <i class="fa-solid fa-camera"></i>
                    </div>
                    <button name="addComment" onclick="addComment('<?php echo $post->getPost_id(); ?>')" type="button">
